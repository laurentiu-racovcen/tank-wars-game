...
void TankWars::CreateMesh(const char* name, const std::vector<VertexFormat>& vertices, const std::vector<unsigned int>& indices)
{
    unsigned int VAO = 0;
...
void TankWars::AddTankMesh(unsigned int index, glm::vec3 color) {
...
void TankWars::AddTankTurretMesh()
{
    vector<VertexFormat> vertices
    {
...
void TankWars::AddTankProjectileMesh()
{
    unsigned int k = 25;
    vector<VertexFormat> vertices;
    vector<unsigned int> indices;
...
void TankWars::AddProjectileTrajectoryMesh()
{
    unsigned int k = 25;
    vector<VertexFormat> vertices;
    vector<unsigned int> indices;
...
void TankWars::AddHealthBarBorderMesh()
{
    vector<VertexFormat> vertices
    {
...
void TankWars::AddHealthBarMesh()
{
    vector<VertexFormat> vertices
    {
...
void TankWars::DrawProjectileTrajectories(unsigned int tankScale)
{
